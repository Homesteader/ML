...
function RoleInfo:genTitle(idx)
	...
	local title = cc.Label:createWithTTF(titletx, "font/gamefont1.TTF", 24)
	title:setTextColor(cc.c3b(102,56,22))
...
function RoleInfo:genBaseAttr()
	...
	--攻击,生命,物防,法防
	for i = 1, 4 do
		local nrtl = xx.RichTextLabel:create(GlobalApi:getLocalStr('STR_ATT'..i), 18, cc.c4b(254, 165, 0, 255))
		...
		local artl = xx.RichTextLabel:create(herrotx[i], 18, cc.c4b(255, 255, 255, 255))
	...
	local attrFrame = ccui.ImageView:create('uires/ui_new/common/common_bg_9.png')
	...
	title:setPosition(cc.p(bgWidth/2, frameHeight + titleInterval + lineHeight))

	local sumHeight = frameHeight + titleInterval * 2 + title:getContentSize().height + lineHeight
	ret:setContentSize(cc.size(bgWidth, sumHeight))
	ret:addChild(attrFrame)

	local line = ccui.ImageView:create('uires/ui_new/common/line3.png')
	line:setAnchorPoint(cc.p(0, 0.5))
	line:setPosition(cc.p(leftInterval, frameHeight + lineHeight))
	ret:addChild(line)
	ret:addChild(title)
...
function RoleInfo:genFightAttr()
	...
	skillRichText:setPosition(cc.p(leftInterval, verticalInterval))
 	for i=1,4 do
 		...
 		local tx3 = att[4+i] .. '  '
 		local re1 = xx.RichTextLabel:create(tx1, 18, cc.c4b(254, 165, 0, 255))
 		re1:setStroke(cc.c4b(0, 0, 0, 255), 1)
 		re1:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))
 		local re3 = xx.RichTextLabel:create(tx3, 18, cc.c4b(254, 165, 0, 255))
 		re3:setStroke(cc.c4b(0, 0, 0, 255), 1)
 		re3:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))

 		local re4 = xx.RichTextLabel:create( '+'..att[19+i].."%", 18, cc.c4b(255, 0, 0, 255))
 		re3:setStroke(cc.c4b(0, 0, 0, 255), 1)
 		re3:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))
 		...
 		local re5 = xx.RichTextLabel:create(str, 18, cc.c4b(36, 255, 0, 255))
 		re3:setStroke(cc.c4b(0, 0, 0, 255), 1)
 		re3:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))

 		local re2 = xx.RichTextLabel:create(tx2, 18, cc.c4b(36, 255, 0, 255))
	...
	local fFrame = ccui.ImageView:create('uires/ui/common/bg1_alpha.png')
	...
	re1:setStroke(cc.c4b(0, 0, 0, 255), 1)
	re1:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))
	local re2 = xx.RichTextLabel:create(tx2, 18, cc.c4b(254, 165, 0, 255))
	re2:setStroke(cc.c4b(0, 0, 0, 255), 1)
	re2:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))
	local re3 = xx.RichTextLabel:create(tx3, 18, cc.c4b(36, 255, 0, 255))
	re3:setStroke(cc.c4b(0, 0, 0, 255), 1)
	re3:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))
...
function RoleInfo:genSkill()
	...
	local frame = ccui.ImageView:create('uires/ui/common/bg1_alpha.png')
	frame:setScale9Enabled(true)
	frame:setAnchorPoint(cc.p(0, 0))

	local frameHeight = txTalentinfo:getContentSize().height + infoInterval + skillbg:getContentSize().height * 0.7 + verticalInterval * 2
...
function RoleInfo:genTalent()
	...
	local txTalentinfo = cc.Label:createWithTTF("", "font/gamefont.ttf", 16)
	txTalentinfo:setTextColor(cc.c3b(255, 255, 255))
	txTalentinfo:enableOutline(cc.c4b(0, 0, 0, 255), 1)
	...
	local rt = xx.RichText:create()
	rt:setContentSize(cc.size(327, 200))
	...
	for i = 2, 12 do
		...
		local tx3 = ''
		local tx4 = ''
		local re1 = xx.RichTextLabel:create(tx1, 16, cc.c4b(163, 163, 163, 255))
		re1:setStroke(cc.c4b(0, 0, 0, 255), 1)
		re1:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))
		local re3 = xx.RichTextLabel:create(tx3, 18, cc.c4b(163, 163, 163, 255))
		re3:setStroke(cc.c4b(0, 0, 0, 255), 1)
		re3:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))

		local re2 = xx.RichTextLabel:create(tx2, 16, cc.c4b(163, 163, 163, 255))
		re2:setStroke(cc.c4b(0, 0, 0, 255), 1)
		re2:setShadow(cc.c4b(40, 40, 40, 255), cc.size(0, -1))

		local re5 = xx.RichTextLabel:create(tx4, 16, cc.c4b(163, 163, 163, 255))
	...
	local bottonBlank = 15 -- 底部留空距离，避免被遮住
	...
	frame:setPosition(cc.p(0, bottonBlank))

	local title = self:genTitle(5)
	title:setPosition(cc.p(titleLeftPadding, frameHeight + titleInterval + bottonBlank + lineHeight))

	local sumHeight = frameHeight + titleInterval * 2 + title:getContentSize().height + bottonBlank + lineHeight
	ret:setContentSize(cc.size(bgWidth, sumHeight))
	ret:addChild(frame)

	local line = ccui.ImageView:create('uires/ui_new/common/line3.png')
	line:setAnchorPoint(cc.p(0, 0.5))
	line:setPosition(cc.p(leftInterval, frameHeight + bottonBlank + lineHeight))
	ret:addChild(line)

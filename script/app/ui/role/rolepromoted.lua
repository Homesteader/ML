...
function RolePromotedUI:initleft()
	...
	self.re1:setFont('font/gamefont1.TTF')
	...
	self.re3:setFont('font/gamefont1.TTF')
	self.re4 = xx.RichTextLabel:create(tx3,26,COLOR_TYPE.WHITE)
	self.re4:setFont('font/gamefont1.TTF')
...
function RolePromotedUI:createAnimation()
	...
	local heroconf,heroCombatConf,heroModelConf = GlobalApi:getHeroConf(self.obj:getId())
	if spineAni then
		...
		spineAni:setPosition(cc.p(self.anim_pl:getContentSize().width/2,10+heroModelConf.uiOffsetY))

...
function CampaignMainUI:addCampaigns()
    ...
    for i = 1, num do
        ...
        elseif i == 4 then
            local useObj = UserData:getUserObj()
            if useObj:getUnlimitedStarsShowStatus() or useObj:getUnlimitedShasShowStatus() or useObj:getUnlimitedBossBoxShowStatus() then

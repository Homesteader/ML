...
function CountryWarOrderUI:updatePanel()
    ...
    for k,v in pairs(self.callList) do
        ...
        if nowTime > beginTime and nowTime < endTime then
            ...
            -- self.cells[currId].flag1:loadTexture('uires/ui/country/flag_'..tab[1]..'.png')
            -- self.cells[currId].flag2:loadTexture('uires/ui/country/flag_'..tab[2]..'.png')
            -- self.cells[currId].flag3:loadTexture('uires/ui/country/flag_'..v.defenseCountry..'.png')

...
function InfiniteBattleBossUI:initLeft()
    ...
    local shadow = spineAni:getBone(monsterModelConf.modelUrl .. "_display_shadow")
    if shadow then
        shadow:changeDisplayWithIndex(-1, true)
    end
    spineAni:setPosition(cc.p(195, 135 + monsterModelConf.uiOffsetY))
    ...
    if self.showAni then
        for i = 1, 6 do
            ...
            if self.infiniteData.boss_level > i then
                difficulty:loadTexture("uires/ui/infinitebattle/difficulty_1.png")
            else
                difficulty:loadTexture("uires/ui/infinitebattle/difficulty_2.png")
            end
        end
        ...
        if lastDifficulty then
            ...
            local difficulty2 = ccui.ImageView:create("uires/ui/infinitebattle/difficulty_1.png")

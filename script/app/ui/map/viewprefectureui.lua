...
function ViewPrefectureUI:timeoutCallback(img,time)
    if time then
        local diffTime = time - GlobalData:getServerTime() + GlobalApi:getGlobalValue('lordMaxHour')*3600
        ...
        if owner then
            ...
            if owner.name then
                ...
                if owner.country and owner.country > 0 then
                    ...
                    self.imgs[i].countryImg:loadTexture("uires/ui/country/flag_" .. owner.country .. ".png")
                else

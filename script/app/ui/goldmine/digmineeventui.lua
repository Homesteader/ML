...
function DigMineEventUI:init()
    ...
    event_bg_img:setCascadeOpacityEnabled(false)
    event_bg_img:setOpacity(180)
...
function DigMineEventUI:initByEventType()
    if self.eventType == "monster" then
        ...
        main_img:loadTexture("uires/ui_new/digmine/event_monster.png")

        local title_tx  = self.event_img:getChildByName("title_tx")
        title_tx:setString(GlobalApi:getLocalStr_new("DIGMINE_EVENT_NAME_1"))

        local ok_btn    = self.event_img:getChildByName("ok_btn")
        ok_btn:setPositionX(680)

        local ok_tx     = ok_btn:getChildByName("ok_tx")
        ok_tx:setString(GlobalApi:getLocalStr_new("BEGIN_FIGHTING"))
        ...
        cancel_tx:setString(GlobalApi:getLocalStr_new("LATER_ON"))
        ...
        local descStr = '<font color="#fef8d5ff" size="26" strokeColor="#6a3d1dff" strokeSize="2">' .. GlobalApi:getLocalStr_new("DIGMINE_EVENT_DESC_1") .. '</font>'
        descStr = string.format(descStr, '</font><font color="#7ff452ff" size="26" strokeColor="#463622ff" strokeSize="2">' .. GlobalApi:getLocalStr_new("DIGMINE_EVENT_DESC_2") .. '</font><font color="#fef8d5ff" size="26" strokeColor="#6a3d1dff" strokeSize="2">')
    ...
    elseif self.eventType == "box" then
        ...
        main_img:ignoreContentAdaptWithSize(true)
        main_img:loadTexture("uires/ui_new/digmine/event_box2.png")

        local title_tx = self.event_img:getChildByName("title_tx")
        title_tx:setString(GlobalApi:getLocalStr_new("DIGMINE_EVENT_NAME_2"))

        local ok_btn = self.event_img:getChildByName("ok_btn")
        ok_btn:setPositionX(480)
        local ok_tx = ok_btn:getChildByName("ok_tx")
        ok_tx:setString(GlobalApi:getLocalStr_new("STR_OPEN"))
        ...
        local descStr = '<font color="#fef8d5ff" size="26" strokeColor="#6a3d1dff" strokeSize="2">' .. GlobalApi:getLocalStr_new("DIGMINE_EVENT_DESC_3") .. '</font>'
        descStr = string.format(descStr, '</font><font color="#7ff452ff" size="26" strokeColor="#463622ff" strokeSize="2">' .. GlobalApi:getLocalStr_new("DIGMINE_EVENT_DESC_4") .. '</font><font color="#fef8d5ff" size="26" strokeColor="#6a3d1dff" strokeSize="2">')
        xx.Utils:Get():analyzeHTMLTag(rt, descStr)
        self.event_img:addChild(rt)
    ...
    elseif self.eventType == "reward" then
         local main_img = self.event_img:getChildByName("main_img")
        main_img:ignoreContentAdaptWithSize(true)
        main_img:loadTexture("uires/ui_new/digmine/event_box1.png")

        local title_tx = self.event_img:getChildByName("title_tx")
        title_tx:setString(GlobalApi:getLocalStr_new("LEGION_LEVELS_DESC8"))

        local ok_btn = self.event_img:getChildByName("ok_btn")
        ok_btn:setPositionX(480)
        local ok_tx = ok_btn:getChildByName("ok_tx")
        ok_tx:setString(GlobalApi:getLocalStr_new("OPEN_AND_SEE"))
        ...
        local descStr = '<font color="#fef8d5ff" size="26" strokeColor="#6a3d1dff" strokeSize="2">' .. GlobalApi:getLocalStr_new("DIGMINE_EVENT_DESC_5") .. '</font>'
        xx.Utils:Get():analyzeHTMLTag(rt, descStr)
        self.event_img:addChild(rt)
    end
end

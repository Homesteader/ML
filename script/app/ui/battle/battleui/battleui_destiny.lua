...
function BattlerDestinyUI:initExtraUI()
	...
	countdownImg:setPosition(cc.p(-66, -340))
    ...
    local descLabel = cc.Label:createWithTTF(self.customObj.desc, "font/gamefont1.TTF", 25)
...
function BattlerDestinyUI:dispatchLegion()
	...
	local co = coroutine.create(function ()
		for k, v in pairs(newLegionArr) do
			...
			local enemyLegion = self:createLegion(2, newV)

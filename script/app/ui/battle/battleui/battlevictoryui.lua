...
function BattleVictoryUI:ctor(displayAwards, starNum, specialAwardDatas, kingLvUpData, notFromBattlefield, damageInfo)
...
function BattleVictoryUI:init()
    ...
    if self.specialAwardDatas then
        ...
        --[[elseif self.specialAwardDatas.battleType == BATTLE_TYPE.TOWER then
            ...
            printall(self.specialAwardDatas)
            -- 添加显示
            ...
            local re2 = xx.RichTextImage:create('uires/ui/res/tower.png')
            
            local num = 0--self.displayAwards[1]:getNum() -- 目前只有塔币
            ...
            local towercoinrewardConf = GameData:getConfData("tower")

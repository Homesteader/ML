...
local GongSunZan = class("GongSunZan", BaseClass)
...
-- 本方所有部队对吴国武将额外造成伤害
function GongSunZan:effectBeforeFight()
	if self.skill1 then
		BattleHelper:addCampCorrection(self.owner.guid, 3, self.value1[1]/100)
	end
end

-- 降低周围防御力
function GongSunZan:effectWhenDie(killer)
	if self.skill2 then

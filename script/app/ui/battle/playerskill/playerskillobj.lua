...
function PlayerSkillObj:getEffect(atker, hpNum, showNum, flag, skillType, damageCoefficient, addAnger)
end
...
function PlayerSkillObj:effectWhenHurtTarget(hpNum, flag, target)
	return hpNum
end

function PlayerSkillObj:effectWhenGetHurt(hpNum, flag, target)
	return hpNum
end

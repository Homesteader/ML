...
function BattleSummon:initAttribute(soldier)
	...
	if soldier.guid == 1 then
		soldier.url = summonModelInfo.modelUrl .. "_g"
	else
		soldier.url = summonModelInfo.modelUrl .. "_r"
	end
	soldier.scale = summonModelInfo.scale
	soldier.hpBarHeight = summonModelInfo.hpBarHeight
	soldier.attPx_t = summonModelInfo.attPx_t
	soldier.attPy_t = summonModelInfo.attPy_t
	soldier.attPx_c = summonModelInfo.attPx_c
	soldier.attPy_c = summonModelInfo.attPy_c
	soldier.attPx_b = summonModelInfo.attPx_b
	soldier.attPy_b = summonModelInfo.attPy_b
	soldier.hitScale = summonModelInfo.hitScale
	soldier.buffScale = summonModelInfo.buffScale

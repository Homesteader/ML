...
function BattleSoldier:initAttribute(soldier)
	...
	local soldierModelConf = GameData:getConfData('model')[baseInfo.modelId]
	soldier.scale = soldierModelConf.scale
	soldier.hpBarHeight = soldierModelConf.hpBarHeight
	soldier.attPx_t = soldierModelConf.attPx_t
	soldier.attPy_t = soldierModelConf.attPy_t
	soldier.attPx_c = soldierModelConf.attPx_c
	soldier.attPy_c = soldierModelConf.attPy_c
	soldier.attPx_b = soldierModelConf.attPx_b
	soldier.attPy_b = soldierModelConf.attPy_b
	soldier.hitScale = soldierModelConf.hitScale
	soldier.buffScale = soldierModelConf.buffScale

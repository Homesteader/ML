...
cc.exports.GAME_UI = {
	...
	UI_ARENA_PREVIEW = 33,					-- 竞技场成就预览
	UI_ARENA_ENTRANCE = 34,					-- 竞技场入口
	UI_ARENA_AWARD = 35,					-- 竞技场奖励
	UI_ARENA_ACHIEVE = 36,					-- 竞技场成就
	UI_SHOP = 37,							-- 商店
	...
	UI_TOWER_ACHIEVEMENT = 47,				-- 爬塔成就界面
	UI_TREASURE = 50,						-- 宝物
	UI_EQUIP_REBUILD = 51,					-- 装备改造
	UI_SOLDIEREQUIPTIPS = 52,				-- 小兵装备tips
	UI_STRENGHENPOPUPUI = 53,				-- 强化
	UI_STOREMAIN = 54,						-- 商店主界面(新)
	...
	UI_TAVEN_NORMAL_PANNEL = 204,			-- 酒馆普通招募(新)
	UI_TAVEN_HIGH_PANNEL = 205,				-- 酒馆高级招募(新)
	UI_EQUIP_ONEKEY_REBUILD = 206,			-- 一键强化/一键精炼
	UI_xxxxxxxxxxxxxxxxx = 207,				-- (已删除)
	...
	UI_GEM_COMPOSE_UI = 432,				-- 宝石合成
	UI_GEM_COMPOSE_DIALOG_UI = 433,			-- 宝石合成对话框
	UI_GEM_DETAIL_UI = 434,                 -- 宝石详情
	UI_HOOK_MAIN_UI = 435,	                -- 大本营主界面(新)
	UI_HOOK_DETAIL_UI = 436,	            -- 大本营详情面(新)
	UI_HOOK_DISPATCH_UI = 437,	            -- 大本营派遣面(新)

	UI_LEGION_TRIAL_MAIN_NEW_PANNEL = 438,					-- 秘境矿洞主界面(新)
	UI_LEGION_TRIAL_ADD_RATE_NEW_PANNEL = 439,				-- 秘境矿洞倍率加成界面(新)
	UI_LEGION_TRIAL_RESET_COIN_NEW_PANNEL = 440,			-- 秘境矿洞硬币重置界面(新)
	UI_LEGION_TRIAL_GET_AWARD_NEW_PANNEL = 441,				-- 秘境矿洞领取奖励界面(新)
	UI_LEGION_TRIAL_ACHIEVEMENT_NEW_PANNEL = 442,			-- 秘境矿洞每周成就奖励界面(新)
	UI_LEGION_TRIAL_ADVENTURE_NEW_PANNEL = 443,				-- 秘境矿洞奇遇界面(新)

	UI_CAVE_ADVENTURE_MAIN_PANEL = 444, 					-- 山洞探险主界面(新)
	UI_CAVE_ADVENTURE_OPEN_BOX_PANEL = 445, 				-- 山洞探险开宝箱界面(新)
...
function UIManager:init(scene, node)
	...
	scene:addChild(promptmgr:init(), 6)
...
function UIManager:getUIName(type)
	if self.uiConf and self.uiConf[type] then
		return self.uiConf[type].name
	end
...
function UIManager:showUI(uiObj, showType)
	...
	logger("going to show:" .. uiData.className..",csb is "..uiData.uiPath.." ,name is"..uiData.name)

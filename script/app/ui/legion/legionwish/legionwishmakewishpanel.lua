...
function LegionWishMakeWishPanelUI:initTop()
    ...
    for k, v in pairs(roleTab) do
    	if tonumber(v:getId()) ~= 0 and not v:isJunZhu() and tonumber(v:getId()) < 10000 and v.quality > 3 then
    ...
    for k, v in pairs(fragmentTab) do
        ...
        if tonumber(v:getId()) ~= 0 and tonumber(v:getId()) < 10000 and quality > 3 and not tablefind(tonumber(v:getId()), cardId) then

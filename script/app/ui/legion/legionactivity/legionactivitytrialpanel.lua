...
function LegionActivityTrialUI:update()
    ...
    local monsterconf,monsterCombatConf,monsterModelConf = GlobalApi:getMonsterConf(bossid)
    self:createAni(self.animpl,monsterModelConf.modelUrl,i,monsterModelConf.uiOffsetY)
    --[[

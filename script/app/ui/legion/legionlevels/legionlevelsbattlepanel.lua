                        ...
                        BattleMgr:showBattleCountDown(BATTLE_TYPE.LEGION, customObj, function (reportField, sig)
                            ...
                            MessageMgr:sendPost("fight", "legion", json.encode(args), function (jsonObj)
                                ...
                                if code == 0 then
                                    ...
                                    BattleMgr:showBattleResultWithoutBattlefield(true, displayAwards, starNum, nil, kingLvUpData, damageInfo)
                                end
                            end)
                        end)
...
function LegionLevelsBattleUI:update()
    ...
    local monsterBaseConf,monsterCombatConf,monsterModelConf = GlobalApi:getMonsterConf(bossid)
    ...
    self.lvLabel:setString(monsterBaseConf.level)

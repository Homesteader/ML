...
function BagMgr:updateRightPanel(obj,bagType,cellId,lightBg)
	
	if self.uiClass['bagUI'] ~= nil then
		self.uiClass['bagUI']:updateRightPanel(obj,bagType,cellId,lightBg)
	end
end
...
function BagMgr:showUse(obj)
	if self.uiClass['useUI'] == nil then
		self.uiClass['useUI'] = ClassUseUI.new(obj,type)

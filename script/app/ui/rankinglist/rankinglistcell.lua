...
function RankingListCellUI:ctor(page)
	...
	self.posImg = posImg
	-- 官职名字
	local posLabel = cc.Label:createWithTTF("", "font/gamefont1.TTF", 26)
	...
	local curRankImg = ccui.ImageView:create("uires/ui/legionwar/rank1.png")
...
function RankingListCellUI:update(page, index, data)
	...
	if page == 1 then -- 战斗力
		-- 名次
		if index <= 3 then
			self.rankImg:loadTexture("uires/ui/rankinglist_v3/rank_" .. index .. ".png")
		...
		if data.uid <= 1000000 then -- 机器人
			...
			local _,heroCombatConf = GlobalApi:getHeroConf(data.main_role)
		...
		-- vip
		self.vipImg:loadTexture("uires/ui/recharge/vip_small.png")
	...
	elseif page == 4 then -- 皇城
		...
		if positionConf[data.posId].position < 3 then
			...
			self.posImg:loadTexture("uires/ui/rankinglist_v3/crown_" .. positionConf[data.posId].position + 1 .. ".png")
		...
		self.countryImg:loadTexture("uires/ui/rankinglist_v3/flag_" .. data.country .. ".png")
		-- 服务器编号
		self.serverLabel:setVisible(false)
		-- 名次
		self.rankImg:setVisible(false)
	...
	elseif page == 5 then -- 军团
		...
		-- 军团人数
		self.fightforceImg:loadTexture("uires/ui/rankinglist_v3/renshu.png")
	...
	elseif page == 6 then -- 群雄争霸
		...
		self.vipLabel2:setVisible(false)
		-- 战斗力
		self.fightforceImg:loadTexture("uires/ui/rankinglist_v3/ji.png")
	...
	elseif page == 8 or page == 9 then -- 军团战
		...
		-- self.vipLabel2:setString(tostring(data.level))
		-- 军团人数
		self.fightforceImg:loadTexture("uires/ui/legionwar/score_icon.png")
		self.fightforceImg:setPosition(cc.p(255, 35))
		self.fightforceLabel:setString(tostring(data.score))
		self.fightforceLabel:setPosition(cc.p(cc.p(290, 35)))
		-- 服务器编号
		...
		-- 国家图标
		self.countryImg:setVisible(false)
		self.countryImg:loadTexture("uires/ui/legionwar/score_icon.png")
		self.viewbtn:setVisible(false)
		self.headframe:setVisible(false)
		...
		-- print("uires/ui/legionwar/rank".. tostring(rankconf[rankid].icon) ..".png")

		self.curRankImg:loadTexture("uires/ui/legionwar/".. tostring(rankconf[rankid].icon))
    ...
    elseif page == 10 then -- 领地战龙境
		...
		-- 击杀数
		self.fightforceImg:loadTexture("uires/ui/territorialwars/kill_num.png")

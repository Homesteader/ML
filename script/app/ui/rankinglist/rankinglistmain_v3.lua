...
local menuTree = {
	[1] = {
		...
		icon_nor = 'uires/ui/rankinglist_v3/zhandouli1.png',
		icon_sel = 'uires/ui/rankinglist_v3/zhandouli2.png',
	...
	[2] = {
		bg_nor = 'uires/ui/common/title_btn_nor_2.png',
		bg_sel = 'uires/ui/common/title_btn_sel_2.png',
		icon_nor = 'uires/ui/rankinglist_v3/leitai1.png',
		icon_sel = 'uires/ui/rankinglist_v3/leitai2.png',
	...
	[3] = {
		bg_nor = 'uires/ui/common/title_btn_nor_2.png',
		bg_sel = 'uires/ui/common/title_btn_sel_2.png',
		icon_nor = 'uires/ui/rankinglist_v3/ta1.png',
		icon_sel = 'uires/ui/rankinglist_v3/ta2.png',
	...
	[4] = {
		bg_nor = 'uires/ui/common/title_btn_nor_2.png',
		bg_sel = 'uires/ui/common/title_btn_sel_2.png',
		icon_nor = 'uires/ui/rankinglist_v3/huangcheng1.png',
		icon_sel = 'uires/ui/rankinglist_v3/huangcheng2.png',
	...
	[5] = {
		bg_nor = 'uires/ui/common/title_btn_nor_2.png',
		bg_sel = 'uires/ui/common/title_btn_sel_2.png',
		icon_nor = 'uires/ui/rankinglist_v3/juntuan1.png',
		icon_sel = 'uires/ui/rankinglist_v3/juntuan2.png',
	...
	[6] = {
		bg_nor = 'uires/ui/common/title_btn_nor_2.png',
		bg_sel = 'uires/ui/common/title_btn_sel_2.png',
		icon_nor = 'uires/ui/rankinglist_v3/zhengba1.png',
		icon_sel = 'uires/ui/rankinglist_v3/zhengba2.png',
    ...
    [10] = {
		...
		bg_nor = 'uires/ui/common/title_btn_nor_2.png',
		bg_sel = 'uires/ui/common/title_btn_sel_2.png',
		icon_nor = 'uires/ui/rankinglist_v3/longjing1.png',
		icon_sel = 'uires/ui/rankinglist_v3/longjing2.png',
    ...
    [11] = {
		...
		bg_nor = 'uires/ui/common/title_btn_nor_2.png',
		bg_sel = 'uires/ui/common/title_btn_sel_2.png',
		icon_nor = 'uires/ui/rankinglist_v3/shenjiang1.png',
		icon_sel = 'uires/ui/rankinglist_v3/shenjiang2.png',
...
function RankinglistV3UI:initMyInfoCell()
	...
	local country = UserData:getUserObj():getCountry()
	if country > 0 then
		countryImg:loadTexture("uires/ui/rankinglist_v3/flag_" .. country .. ".png")
	end
	-- 对比箭头
...
function RankinglistV3UI:updateMyInfo(page, data)
	...
	if page == 1 or page == 2 or page == 11 then -- 战斗力
		...
		-- vip
		vipImg:loadTexture("uires/ui/recharge/vip_small.png")
		...
		if data.rank == 0 then -- 未上榜
			...
			-- 名次
			if data.rank <= 3 then
				rankImg:loadTexture("uires/ui/rankinglist_v3/rank_" .. data.rank .. ".png")
	...
	elseif page == 4 then -- 皇城
		...
		if UserData:getUserObj():getCountry() > 0 then
			...
			if positionConf[data.posId].position < 3 then
				...
				posImg:loadTexture("uires/ui/rankinglist_v3/crown_" .. positionConf[data.posId].position + 1 .. ".png")
	...
	elseif page == 5 then -- 军团
		if data.myLegion then
			...
			-- 军团人数
			fightforceImg:loadTexture("uires/ui/rankinglist_v3/renshu.png")
			...
			if data.myLegion.rank == 0 then -- 未上榜
				...
				if data.myLegion.rank <= 3 then
					rankImg:loadTexture("uires/ui/rankinglist_v3/rank_" .. data.myLegion.rank .. ".png")
					rankImg:setVisible(true)
					rankLabel:setVisible(false)
				else
					rankImg:setVisible(false)
	...
	elseif page == 6 then -- 群雄争霸
		...
		vipLabel2:setVisible(false)
		-- 战斗力
		fightforceImg:loadTexture("uires/ui/rankinglist_v3/ji.png")
	...
	elseif page == 7 then -- 人品
		...
		elseif data.rank == 1 then
			...
			rankLabel:setVisible(false)
			rankImg:setVisible(false)
	        posImg:loadTexture("uires/ui/rankinglist_v3/crown_1.png")
	    ...
	    elseif data.rank == 2 then
			...
			rankLabel:setVisible(false)
			rankImg:setVisible(false)
	        posImg:loadTexture("uires/ui/rankinglist_v3/crown_2.png")
	    ...
	    elseif data.rank == 3 then
			...
			rankLabel:setVisible(false)
			rankImg:setVisible(false)
	        posImg:loadTexture("uires/ui/rankinglist_v3/crown_3.png")
	...
	elseif page == 8 or page == 9 then -- 军团战
		if data.myLegion then
			...
			countryImg:setVisible(true)
			headframe:setVisible(false)
			countryImg:loadTexture("uires/ui/legionwar/score_icon.png")
			diffImg:setVisible(false)
			if data.myLegion.curRank == 0 then -- 未上榜
				...
				if data.myLegion.curRank <= 3 then
					rankImg:loadTexture("uires/ui/rankinglist_v3/rank_" .. data.myLegion.curRank .. ".png")
					rankImg:setVisible(true)
					rankLabel:setVisible(false)
				else
					rankImg:setVisible(false)
    ...
    elseif page == 10 then
		...
		-- 击杀数
		fightforceImg:loadTexture("uires/ui/territorialwars/kill_num.png")

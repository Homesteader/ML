...
function FriendsBossPanelUI:init()
    ...
    local rt2 = xx.RichTextImage:create("uires/ui/friends/attack.png")
...
function FriendsBossPanelUI:update()
    ...
    local _,_,monsterModelConf = GlobalApi:getMonsterConf(mosterid)
    local bigimg = 'uires/icon/big_hero/'..monsterModelConf.modelUrl..'.png'

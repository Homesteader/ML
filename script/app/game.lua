local SCRIPT_FILES = {
	...
	"script/app/ui/hook/hookheromgr",
    ...
    "script/app/ui/infinitebattle/infinitebattlemanager",
    ...
    "script/app/ui/cave/caveadventuremgr",
}
...
function Game:start()
	...
	logoScene:enter()
	LoginMgr:footprint('client_start')
end
